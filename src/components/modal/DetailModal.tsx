      ...
      <Dialog as="div" className="relative z-10" onClose={closeModal}>
        ...
        <div className="fixed inset-0 max-md:bottom-0 max-md:inset-auto max-md:w-full">
          <div className="flex min-h-full items-center justify-center md:p-4">
            ...
            >
              <Dialog.Panel className="flex flex-col max-md:h-[76vh] overflow-y-auto space-y-4 w-screen md:w-full md:max-w-screen-md lg:max-w-screen-lg transform rounded-xl max-md:rounded-b-none bg-white backdrop-blur p-6 text-left shadow-xl">
                <div className="w-full flex max-md:flex-col max-md:space-y-2 items-end md:items-center justify-between">
                  <div className="w-full flex items-center space-x-3">
                    ...
                    <div className="flex flex-col md:-space-y-1">
                      <h2 className="md:text-lg lg:text-xl capitalize font-semibold text-zinc-900">
                        {user?.first_name} {user?.last_name}{' '}
                        <strong className="font-normal text-zinc-500 text-xs md:text-sm lg:text-base">
                          on Unsplash
                        </strong>
                      </h2>
                  ...
                  <div className="w-fit flex items-center bg-[#3DB46E] hover:bg-opacity-80 rounded-lg">
                    <button
                ...
                <img
                  className="h-2/3 md:h-[50vh] object-contain"
                  src={urls.regular}
                  alt={alt}
                />
                <section>
                  <div className="flex space-x-10">
                    <div className="flex flex-col">
                      ...
                      <span className="max-md:text-sm text-slate-600">
                  ...
                  <h2 className="mt-3 md:mt-5 md:text-lg lg:text-xl font-semibold">
                    {alt}
                  </h2>
                  <time className="max-md:text-sm text-slate-500">
